...
@router.post("/permissions/add", summary="创建权限")
...
@router.put("/permissions/update/{permission_id}", summary="更新权限")
...
@router.get("/permissions/detail/{permission_id}", summary="获取权限详情")
